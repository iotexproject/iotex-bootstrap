...
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.4.5/config_mainnet.yaml > $IOTEX_HOME/etc/config.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.4.5/genesis_mainnet.yaml > $IOTEX_HOME/etc/genesis.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.4.5/trie.db.patch > $IOTEX_HOME/data/trie.db.patch
```
...
| `--version=v2.4.5` | Target version (default: latest release) |
...
bash setup_fullnode.sh --auto --home=/path/to/iotex-var --version=v2.4.5
```
...
```
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.4.5/txlog.db.patch > $IOTEX_HOME/data/txlog.db.patch
