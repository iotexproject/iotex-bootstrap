...
```
docker pull iotex/iotex-core:v1.7.0
```
...
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v1.7.0/config_mainnet.yaml > $IOTEX_HOME/etc/config.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v1.7.0/genesis_mainnet.yaml > $IOTEX_HOME/etc/genesis.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v1.7.0/trie.db.patch > $IOTEX_HOME/data/trie.db.patch
```
...
```
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v1.7.0/config_testnet.yaml > $IOTEX_HOME/etc/config.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v1.7.0/genesis_testnet.yaml > $IOTEX_HOME/etc/genesis.yaml
```
