...
This repository is versioned in sync with [iotex-core](https://github.com/iotexproject/iotex-core). The current release is **v2.4.5**. When iotex-core releases a new version:
...
1. Update `version` references in README.md (search for `v2.4.5`)
