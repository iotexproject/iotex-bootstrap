...
```
docker pull iotex/iotex-core:v2.0.2
```
...
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.0.2/config_mainnet.yaml > $IOTEX_HOME/etc/config.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.0.2/genesis_mainnet.yaml > $IOTEX_HOME/etc/genesis.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.0.2/trie.db.patch > $IOTEX_HOME/data/trie.db.patch
```
