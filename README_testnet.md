...
```
docker pull iotex/iotex-core:v2.2.0-rc3
```
...
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.2.0-rc3/config_testnet.yaml > $IOTEX_HOME/etc/config.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.2.0-rc3/genesis_testnet.yaml > $IOTEX_HOME/etc/genesis.yaml
```
