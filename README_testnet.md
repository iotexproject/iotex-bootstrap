...
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v1.12.0/config_testnet.yaml > $IOTEX_HOME/etc/config.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v1.12.0/genesis_testnet.yaml > $IOTEX_HOME/etc/genesis.yaml
```
