...
```
docker pull iotex/iotex-core:v2.1.0-rc10
```
...
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.1.0-rc10/config_testnet.yaml > $IOTEX_HOME/etc/config.yaml
curl https://raw.githubusercontent.com/iotexproject/iotex-bootstrap/v2.1.0-rc10/genesis_testnet.yaml > $IOTEX_HOME/etc/genesis.yaml
```
