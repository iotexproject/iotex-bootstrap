...
- Request IOTTT (testing tokens on Ethereum mainnet) with `curl -H "Content-Type: application/json" -X POST https://iotex-tube.herokuapp.com/tokenrequest --data '{"address":"0xcb816E0491Ce3b66f33304473468698Aae97Cc0a","amount":"2000000","asset":"et"}' | jq`. Note that the min requested amount is 100,000 while the max is 3,000,000. Note that you will need at least 2,000,000 IOTTT to get elected as delegates on testnet.
