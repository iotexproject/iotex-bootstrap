...
- Request IOTTT (testing tokens on Ethereum mainnet) using `curl -H "Content-Type: application/json" -X POST https://iotex-tube.herokuapp.com/tokenrequest --data '{"address":"[YOUR ETH ADDRESS]","amount":"2000000","asset":"et"}' | jq`. Note that the min requested amount is 100,000 while the max is 3,000,000, and you will need at least 2,000,000 IOTTT to get elected as delegates on testnet.
